...
const llmsLines = [
	...
	`- [OpenID Federation 1.1](https://openid.net/specs/openid-federation-1_1.html) — protocol-independent successor layer.`,
	`- [OpenID Federation for OpenID Connect 1.1](https://openid.net/specs/openid-federation-connect-1_1.html) — protocol-specific successor layer.`,
	``,
	`## Project Metadata`,
	``,
