...
export function InputGroup({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: input group wrapper, <fieldset> would break styling
		<div
			className={cn(
...
export function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: intentional focus-forwarding onMouseDown for UX
		<div
