...
|---------|------|--------------------------|------|
| `@oidfed/core` | Federation primitives — Entity Statement builders, trust chain resolution, metadata policy, and cryptographic verification. The foundational layer for OpenID Federation 1.0 deployments | Any federation participant | [docs/packages/core.md](docs/packages/core.md) |
